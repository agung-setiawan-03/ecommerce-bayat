                ...
                <div class="card-body">
                    <form action="{{route('admin.slider.update', $slider->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="type" value="{{$slider->tipe}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="starting_price" value="{{$slider->harga_awal}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="inputState" class="form-control" name="status">
                              ...
                              <option {{$slider->status == 0 ? 'selected': ''}} value="0">Tidak Aktif</option>
                            </select>
                          </div>
